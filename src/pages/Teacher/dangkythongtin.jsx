...
function DangKyThucTap() {
  ...
  function Dangky() {
    ...
    axios.post('http://localhost:3001/teacher/themthongtingiaovien', ThongTinDangKy)
      .then(response => {
        ...
        <div className='container'>
          <div className='Navbar'>
            <ul id='navbar' className='company'>
              ...
              <Link to={`/teacher/thongtin/taikhoan?taikhoan=${taikhoan}`}><a href=""><li id='thongtin' className='click' ><AiOutlineInfoCircle className='icon'/>Thông tin</li></a></Link>
            </ul>
            <Link to="/"><a id='dangxuat' href="" className='dangxuatcongty'><FiLogOut className='icon'/>Đăng xuất</a></Link>
          </div>
          <div className='data'>
              <div className="header"><AiOutlineHome className='icon' /><span id='route'>/Đăng ký thông tin</span></div>
              <div id='dondangky' className="content">
                    <div className="thongtincongty company">
                      ...
                      <ul className='thongtindangkythuctap email_dangky'>
                          ...
                          <li>
                            <input id='tengiaovien'  placeholder='Tên giáo viên' type="text"/>
                          </li>
                          <li></li>
                      </ul>
