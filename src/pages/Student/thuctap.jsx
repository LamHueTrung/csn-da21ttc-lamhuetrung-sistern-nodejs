                    ...
                    <div className="thongtincanhan">
                        <ul className='thongtintaikhoan'>
                            <li>
                                ...
                                <span className='info'>{ThongTinThucTap.trangthaidon}</span>
                            </li>
                        </ul>
                    </div>
                    <div className="thongtincanhan">
                    <h1 className="lable_chitiet">Thông tin đơn thực tập</h1>
                      <ul className='thongtintaikhoan'>
                      ...
                      <ul className='thongtintaikhoan'>
                          <li>
                              ...
                              <span className='info'>{ThongTinGiaoVien.hoten}</span>
                          </li>
                          <li>
                              <span className='lable'>Email giáo viên</span>
                              <span className='info'>{ThongTinGiaoVien.email}</span>
                          </li>
                          <li>
                              <span className='lable'>Chức vụ</span>
                              <span className='info'>{ThongTinGiaoVien.chucvu}</span>
                          </li>
                      </ul>
                      <ul className='thongtintaikhoan'>
                          <li>
                              <span className='lable'>Người phụ trách</span>
                              <span className='info'>{ThongTinCanBoHD.hoten}</span>
                          </li>
                          <li>
                              <span className='lable'>Email người phụ trách</span>
                              <span className='info'>{ThongTinCanBoHD.email}</span>
                          </li>
                          <li>
                              <span className='lable'>Chức vụ</span>
                              <span className='info'>{ThongTinCanBoHD.chucvu}</span>
                          </li>
                      </ul>
                      <ul className='thongtintaikhoan'>
                          <li>
                              <span className='lable'>Tên công ty</span>
                              <span className='info'>{ThongTinCongTy.tencongty}</span>
                          </li>
                          <li>
                          ...
                          <li>
                              ...
                              <span className='info'>{ThongTinCongTy.vitri}</span>
                          </li>
                      </ul>
                      <ul className='thongtintaikhoan'>
                          <li>  
                              <span className='lable'>Ngày bắt đầu</span>
                              <span className='info'>{ThongTinThucTap.ngaybatdau}</span>
                          </li>
                          <li>
                              <span className='lable'>Ngày kết thúc</span>
                              <span className='info'>{ThongTinThucTap.ngayketthuc}</span>
                          </li>
                          <li>
                              <span className='lable'>Số buổi/tuần</span>
                              <span className='info'>{ThongTinThucTap.sobuoi}</span>
                          </li>
                          <li>
                              <span className='lable'>Số tuần</span>
                              <span className='info'>{ThongTinThucTap.sotuan}</span>
                          </li>
                      </ul>
                    </div>
                    <div className="thongtincanhan">
